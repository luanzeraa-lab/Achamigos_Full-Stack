  ...
  return (
    <section className="d-flex justify-content-center mt-4">
      <div
        ...
        className="carousel slide w-2/3"
      ...
      >
        ...
        >
          <span
            className="carousel-control-prev-icon  p-4 m-2 hover:scale-150"
            aria-hidden="true"
          ></span>
        ...
        >
          <span
            className="carousel-control-next-icon  p-4 m-2 hover:scale-150"
            aria-hidden="true"
          ></span>
